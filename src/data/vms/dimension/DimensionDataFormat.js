...
const DimensionDataFormat = ({ data }) => {

  console.log("Dimension Data Formate Data is==", data);
  ...
  return (
    <>
      {data.length == 0 ? (
        ...
        <>
          {data.map((item, index) => {
            console.log("return Dimension data Formate Data is==", item);
            return (
              <>
                <tr
                  key={index}
                ...
                >
                  ...
                  <Link to="/vehicleDimension/AddVehicleDimension"
                    state={{ item: item }}>
                  ...
                  <td>{item.width}</td>
                  <td>{item.height}</td>
                  <td>{item.interior_volume}</td>
                  <td>{item.passenger_volume}</td>
                  <td>{item.cargo_volume}</td>
                  <td>{item.ground_clearance}</td>
                  <td>{item.bed_length}</td>
                </tr>
              </>
            );
          })}
...
export default DimensionDataFormat;
