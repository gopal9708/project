...
const BinPropertyDataFormat = ({ data }) => {
  console.log("BinPropertyDataFormat data====", data) 
  ...
  return (
    <>
      {data.length === 0 ? (
        ...
        <>
          {data.map((item, index) => {
            console.log("return Bin PROPERTY DATA FORMATE is==", item)
            ...
            return (
              <>
                ...
                >
                  ...
                  <Link to="/wms/bindetails/binproperty/AddBinProperty"
                    state={{ item: item }}>
                    <td>{item.name}</td>
                  </Link>
...
export default BinPropertyDataFormat;
