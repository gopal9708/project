...
const BinSizeDataFormate = ({ data }) => {
  console.log("BinSizeDataFormate data====", data)
  ...
  return (
    <>
      {data.length == 0 ? (
        ...
        <>
          {data.map((item, index) => {
            console.log("return binsize DATA FORMATE is==", item)
            ...
            return (
              <>
                ...
                >
                  ...
                  <Link to="/wms/bindetails/binsize/AddBinSize"
                    state={{ item: item }}>
                    <td>{item.name}</td>
                  </Link>
                  <td>{item.wide}</td>
...
export default BinSizeDataFormate