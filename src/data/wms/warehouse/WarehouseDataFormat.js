...
const WarehouseDataFormat = ({ data }) => {
            ...
            return (
              <>
                ...
                >
                  ...
                  <td>{item.contact}</td>
                  <td>{item.manager}</td>
                  <td>{item.open_storage.length > 0 ? "T" : "f"}</td>
                  <td>{item.bulk_storage.length > 0 ? "T" : "f"}</td>
                  <td>{item.high_rack.length > 0 ? "T" : "f"}</td>
...
export default WarehouseDataFormat;
