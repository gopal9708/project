...
const AccountDataFormat = ({ data, data1 }) => {
  ...
  const delete_select_item = () => {
    axios
      .post(
        ServerAddress + "finance/delete-AccountMaster/",
        {
          data: ids,
        },
        {
            ...
            return (
              <tr key={index} style={{ borderWidth: 1 }}>
                ...
                <td>
                  <Link
                    state={{ data: item }}
                    to="/finance/accountmaster/addaccountmaster"
                  >
                    {item.code}
                  </Link>
                </td>
...
export default AccountDataFormat;
