...
const UserStepForm = () => {
  ...
  console.log("temporary_add_line1>>>>>>>", temporary_add_line1);
  ...
  console.log("get_employee_basic_info",get_employee_basic_info)
  ...
  // console.log("education list is", education_info);
  // for new row
  ...
  const get_identifaction_info = (id) => {
    console.log("get_identifaction_info",get_identifaction_info)
    axios
      ...
      .then((resp) => {
        ...
        if (resp.status === 200) {
          if (resp.data.length !== 0) {
            ...
            console.log("temi_list1=====",temp_list1)
      ...
      .then((resp) => {
        ...
        if (
          ...
          if (
            ...
            setsame_as_permanent_add(false);
          }
    ...
    axios
      ...
      .then(function (resp) {
        if (resp.data.status === "success") {
          setshow_loader(false);
          handleCls();
          navigate("/ems/employee/UserFormComplete");
        }
  ...
  const [accepr_tnc, setaccepr_tnc] = useState(false);
  const [confirmation, setconfirmation] = useState("");
  const [show, setShow] = useState(false);
  const [value_is, setvalue_is] = useState({});
              ...
              >
                ...
                <TabPane tabId="6">
                  <Row>
                    <Col sm="12">
                      <CardText className="mb-0">
                        <Modal size="lg" show={show} onHide={handleCls}>
                          ...
                          <Modal.Body style={{ fontSize: "14px" }}>
                            ...
                            >
                              ...
                              <p>
                                Terms and conditions for hiring an employee can
                                vary depending on the organization and the
                                specific requirements of the position. However,
                                I can provide you with a general outline of
                                common terms and conditions that are often
                                included in employment agreements. It's
                                important to note that it's always recommended
                                to consult with legal professionals to ensure
                                compliance with applicable laws and regulations.
                                Here's an example of the terms and conditions:
                              </p>
                              <p>
                                * Employment Relationship: This section outlines
                                the nature of the employment relationship,
                                stating that the individual is being hired as an
                                employee and not as an independent contractor or
                                consultant.
                              </p>
                              <p>
                                * Position and Duties: Describes the position
                                title, job description, and the specific duties
                                and responsibilities the employee is expected to
                                fulfill.
                              </p>
                              <p>
                                * Compensation: Specifies the details of the
                                employee's compensation, including base salary,
                                bonuses, commission structure (if applicable),
                                and any additional benefits such as health
                                insurance, retirement plans, or vacation days.
                              </p>
                              <p>
                                * Work Schedule: Defines the employee's working
                                hours, days of the week, and any flexible or
                                alternative work arrangements, if applicable.
                              </p>
                              <p>
                                * Probationary Period: If there is a
                                probationary period, this section outlines its
                                duration, objectives, and the conditions that
                                need to be met for successful completion.
                                <p>
                                  * Confidentiality and Non-Disclosure: Requires
                                  the employee to maintain the confidentiality
                                  of sensitive company information and prohibits
                                  the disclosure of proprietary information to
                                  third parties.
                                </p>
                                <p>
                                  * Intellectual Property: Clarifies that any
                                  work created by the employee during their
                                  employment is the property of the company and
                                  should not be used or disclosed without proper
                                  authorization.
                                </p>
                                <p>
                                  * Termination: Outlines the conditions under
                                  which either party can terminate the
                                  employment relationship, including notice
                                  periods, severance packages, and any specific
                                  grounds for immediate termination (e.g.,
                                  misconduct, breach of contract).
                                </p>
                                <p>
                                  * Non-Compete and Non-Solicitation: States any
                                  restrictions on the employee's ability to
                                  compete with the company or solicit clients or
                                  employees for a specified period of time after
                                  the employment ends.
                                </p>
                                <p>
                                  * Dispute Resolution: Specifies the methods
                                  and procedures for resolving disputes that may
                                  arise during the employment, such as
                                  mediation, arbitration, or litigation.
                                </p>
                                <p>
                                  * Governing Law: Determines the jurisdiction
                                  and laws that will govern the employment
                                  agreement.
                                </p>
                                <p>
                                  * Entire Agreement: States that the employment
                                  agreement constitutes the entire agreement
                                  between the parties and supersedes any
                                  previous discussions or agreements.
                                </p>
                                <p>
                                  * Please note that this is a general outline,
                                  and specific terms and conditions may vary
                                  depending o Do You Want Create or Update
                                  Agrement Information?n the organization's
                                  policies and applicable laws. It is always
                                  recommended to consult with legal
                                  professionals to tailor the terms and
                                  conditions to your organization's specific
                                  needs.
                                </p>
                              </p>
                              <div>
                                <b>
                                  Click on this check box to accept term's &
                                  conditions
                                </b>

                                <input
                                  onClick={() => {
                                    setaccepr_tnc(!accepr_tnc);
                                  }}
                                  type="checkbox"
                                  checked={accepr_tnc === true}
                                />
                              </div>
                            </div>
                          </Modal.Body>
                          <Modal.Footer>
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                // Update_client_data(value_is, "create");
                              }}
                            >
                              Reject
                            </Button>
