...
const AddAsn = () => {
  ...
  // add Another
    ...
    // const add_asn = (values) => {
    //   alert("Add asn called----")
    //   axios
    //     .post(
    //       // ServerAddress + "wms/add_binproperty/",
    //       {
    //         name: values.supplier_name.toUpperCase(),
    ...
    //       console.log("add asn response==", response.data)
    //     if (response.data.status === "success") {
    //       dispatch(setToggle(true));
    //       dispatch(setShowAlert(true));
    //       dispatch(
    //         setDataExist(
    //           `asn "${toTitleCase(values.asn)}" Added sucessfully.`
    //         )
    //       );
    ...
    //       dispatch(
    //         setDataExist(
    //           `asn "${toTitleCase(values.asn)}" already exists`
    //         )
    //       );
          ...
          <CardBody>
            <Row>
              <>
                ...
                <Col lg={3} md={6} sm={6}>
                    <div className="mb-3">
                      <Label className="header-child">Supplier Name </Label>
                      {row.map((item, index) => {
                        return (
                          <Input
                            min={0}
