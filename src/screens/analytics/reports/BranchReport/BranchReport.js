...
const BranchReport = () => {
    ...
    const getBranch = () => {
      ...
      const getBranchReportData = (branches) => {
        let temp2 = [];
        axios
          .post(
            ServerAddress + "analytic/get_branch_report/?username=" + username,
            {
          ...
          .then((response) => {
            ...
            //  console.log("records2", records2)
              ...
              // records[records.length-1]= records[records.length-1][0]
              // console.log("records2",records)
              // for (const i of sample_data) {
              //   console.log("print", i)
    ...
    return(
        <div>
            <PageTitle page="Branch Report" />
            <Title title="Branch Report" parent_title="Analytics" />
            <div className="mx-3">
