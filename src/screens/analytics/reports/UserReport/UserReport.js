...
const UserReport = () => {
    ...
    const rmv_title = col => {
      ...
      const getUserReportData = (branches) => {
        let temp2 = [];
        axios
          .post(
            ServerAddress + "analytic/get_user_report/?username=" + username,
            {
    ...
    return(
        <div>
            <PageTitle page='User Report' />
            <Title title='User Report' parent_title='Analytics' />
            <div className="mx-3">
