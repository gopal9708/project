...
const VehicleTabs = () => {
  ...
  const [vehicletab_up, setvehicletab_up] = useState("");
  console.log("vehicletab_up==",vehicletab_up);
  ...
  useLayoutEffect(() => {
    try {
      setvehicletab_up(location.state.item);
    } catch (error) {
      alert(error);
    }
  }, []);
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {" "}
                        <AddFuel
                          data={vehicletab_up.registeration_no}
                          id={vehicletab_up.id}
                        />
                      </span>
                      <span
                                ...
                                <CardBody>
                                  <div>
                                    ...
                                    >
                                      ...
                                      >
                                        {vehicletab_up.container_capacity}
                                      </span>{" "}
                                    </h6>
                                    ...
                                    >
                                      ...
                                      Transporter Name :{" "}
                                      <span
                                        className="badge bg-white rounded-pill"
                                        style={{
                                          fontWeight: "500",
                                          position: "absolute",
                                          left: "20rem",
                                  ...
                                  <div>
                                    ...
                                    >
                                      <thead style={{ color: "black" }}>
                                        ...
                                        >
                                          <th>{vehicletab_up.vehicle_number}</th>
                                          <th>{vehicletab_up.model_nm}</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                        {" "}
