...
import IncomingRunsheetHubTitle from "../../../data/runsheets/incomingHubRunsheet/IncomingRunsheetHubTittle";
import Navigate from "../runsheetTab/Navigate";
import NumPagination from "../../../components/listDisplay/numPagination/NumPagination";
import IncomingRunsheetHubDataFormat from "../../../data/runsheets/incomingHubRunsheet/IncomingRunsheetHubDataFormat";

const IncomingRunsheetHub = () => {
  ...
  return (
    <>
      ...
      <Navigate />
      <Title title="Incoming Hub" parent_title="Runsheet" />
      <div className="mx-3">
...
export default IncomingRunsheetHub;
